...
const ResponsiveForm = ({ children, onSubmit }: FormProps) => (
  <div className='w-full h-full flex justify-center items-center'>
    <div className='flex w-full h-full sm:h-auto sm:w-1/2 sm:min-h-[50%] sm:max-h-[90%] justify-center items-start sm:shadow-md sm:rounded-lg p-5 bg-white overflow-y-scroll'>
